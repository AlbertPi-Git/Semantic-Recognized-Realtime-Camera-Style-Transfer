...
def webcam():
    ...
    with torch.no_grad():
        while True:
            ...
            # Style transfer
            with torch.no_grad():
                human_tensor = style_transfer(vgg, decoder, content_tensor, human_style_tensor,alpha=args.ratio)
                background_tensor = style_transfer(vgg, decoder, content_tensor, background_style_tensor,alpha=args.ratio)
