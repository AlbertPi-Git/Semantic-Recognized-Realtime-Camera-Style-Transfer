...
# Basic options
parser.add_argument('--content', type=str, default = 'input/content/selfie.jpg',
...
parser.add_argument('--vgg', type=str, default = 'model_checkpoints/vgg_normalised.pth')
parser.add_argument('--decoder', type=str, default = 'model_checkpoints/decoder.pth')
parser.add_argument('--transform', type=str, default = 'model_checkpoints/transformer.pth')
